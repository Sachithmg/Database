...
// Access the database
const db = conn.getDB('social_media_platform');

print("------------Drop database--------------------- \n");
db.dropDatabase();

// Switch to a different database
db.getSiblingDB('social_media_platform');
print("-----------Switch to new database social_media_platform---------------- \n");
...
print('------------------------------********************----------------------------------------- \n');
print('19. Find the most common city where users have their home town \n');
...
print('------------------------------********************----------------------------------------- \n');
print('20. Find the users who have posted the most number of photos \n');
...
if (albumCounts.length  > 0) {
  albumCounts.sort((a, b) => b.photoCount - a.photoCount);

  const highestPhotoCount = albumCounts[0].photoCount;

  const usersWithHighestPhotoCount = db.users.find({ _id: { $in: albumCounts.filter(album => album.photoCount === highestPhotoCount).map(album => album.userId) } });

  usersWithHighestPhotoCount.forEach(user => {
...
print('------------------------------********************----------------------------------------- \n');
print('21. Find the users who have not posted any photos or videos \n');
